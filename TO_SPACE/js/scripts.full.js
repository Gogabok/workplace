...
$(function () {
  ...
  function doPayout(persent) {
    ...
    return rounded(amount * Math.floor(98500/(99-persent))/1000);
  }

	function doMultiple(persent) {

		return Math.floor(98500/(99-persent))/1000 + 'X';
	...
	$("#slider1").slider({
		...
		slide: function (event, ui) {
			...
			checkMaxBet("#bet-amount", "#payout", multi, $("#bet-amount").val()*1e6);
		}
	});
	...
	$("#bet-amount").on('keyup', function () {
		...
		checkMaxBet("#bet-amount", "#payout", multi, current*1e6);
	});
	...
	$(".ch-coin").on('click', function () {
		...
		$(".frame1").find('img').attr('src', link);
		$(".jackpot1").find('img').attr('src', link);
		$(".wagered1").find('img').attr('src', link);
		$(".profit1").find('img').attr('src', link);
		*/
	});
	...
	$(".lex-coin").on('click', function () {
			...
			$("#infobox2").html("LEX betting is underconstruction...");
			$("#infobox2").show();			
			setTimeout(function() {
				$("#infobox2").hide();
			}, 3000);			
	...
	$(".btt-coin").on('click', function () {
			$("#infobox2").html("BTT betting is underconstruction...");
			$("#infobox2").show();			
			setTimeout(function() {
				$("#infobox2").hide();
			}, 3000);			
  ...
  $(".roll1").on('click', function () {
	...
	//console.log($(".prediction .num").text());
	//console.log($("#bet-amount").val());
	//console.log($(".wagered span").text());
...
/*  
	$(".roll1").on('click', function () {
		...
		setTimeout(function () {
			...
			$(".roll1 button").prop('disabled', false);
		}, 2500);
	});
*/
	...
	$("a.bet-2xX50").on('click', function (e) {
		if (trx) {
			if ($("#bet-amountx50").val() == 10000 || $("#bet-amountx50").val() > 4999) return false;
		}
		if (lex) {
			if ($("#bet-amountx50").val() == 1000 || $("#bet-amountx50").val() > 500) return false;
		}
		if (btt) {
			if ($("#bet-amountx50").val() == 10000 || $("#bet-amountx50").val() > 4999) return false;
		}
		var current = $("#bet-amountx50").val() * 2;
		$("#bet-amountx50").val(current);
		rewriting()
	});
	$("a.bet-halfX50").on('click', function (e) {
		if (trx) {
			if ($("#bet-amountx50").val() == 10 || $("#bet-amountx50").val() < 20) return false;
		}
		if (lex) {
			if ($("#bet-amountx50").val() == 1 || $("#bet-amountx50").val() < 2) return false;
		}
		if (btt) {
			if ($("#bet-amountx50").val() == 500 || $("#bet-amountx50").val() < 1000) return false;
		}
		var current = $("#bet-amountx50").val() / 2;
		$("#bet-amountx50").val(current);
		rewriting()
	});
	$("a.bet-minX50").on('click', function (e) {
		var current = 1;
		if (trx) {
			current = 10;
		}
	...
	$("a.bet-maxX50").on('click', function (e) {
		var current = 10000;
		if (trx) {
			current = 10000;
		}
...
$(".navigation-item-container-menu-2").click(function () {
	$("#header-scnd-menu-1").toggle()
	$(".navigation-item-container-menu-2").toggleClass("navigation-item-container-menu-active")
});


$(document).mouseup(function (e) {
	var $target = $(e.target);
	if ($target.closest("#header-scnd-menu-1").length == 0 && $target.closest(".navigation-item-container-menu-2").length == 0) {
		$("#header-scnd-menu-1").hide()
		$(".navigation-item-container-menu-2").removeClass("navigation-item-container-menu-active")
	}
});



$("#gamesRouter").click(function () {
	$("#header-scnd-menu-2").toggle()
	$("#gamesRouter").toggleClass("gamesRouter-active")
});
	$(document).mouseup(function (e) {
		var $target = $(e.target);
		if ($target.closest("#header-scnd-menu-2").length == 0 && $target.closest("#gamesRouter").length == 0) {
				$("#header-scnd-menu-2").hide()
				$("#gamesRouter").removeClass("gamesRouter-active")
			}
	});


$(".hamburger-game5").click(function () {
	$(".game-5-hamMenu").toggle()
	$(".hamburger-game5").toggleClass("navigation-item-container-menu-active")
});
$(document).mouseup(function (e) {
	var $target = $(e.target);
	if ($target.closest("#header-scnd-menu-2").length == 0 && $target.closest(".hamburger-game5").length == 0) {
		$(".game-5-hamMenu").hide()
		$(".hamburger-game5").removeClass("navigation-item-container-menu-active")
	}
});
...
$(".statistic-table-item").hide()
$(".statistic-table-item-1").show()
$(".statistic-table-nav-item").on("click", function () {
	$(".statistic-table-nav-item").removeClass("statistic-table-nav-item-active")
	$(this).addClass("statistic-table-nav-item-active")
	$(".statistic-table-item").hide()
	$(".statistic-table-item-" + this.id).show()
})
...
$(document).ready(function () {
	$(".blur").hide();
	// $(".blur").hide()
	$("#faqModal .item-content").hide();
	$("#faqModal .game-rule-content-item").on("click", function (e) {
		$("#faqModal .item-content").not($(this).next()).slideUp("slow")
		$(this).next().stop()
...
$(document).ready(function () {
	...
	$("#rulesModal .game-rule-content").hide()
	$("#rulesModal .game-rule-head").on("click", function (e) {
		$("#rulesModal .game-rule-content").not($(this).next()).slideUp("slow")
		$(this).next().stop()
		$(this).next().slideToggle("slow")
		$("#header-scnd-menu-1").hide()
		$(".navigation-item-container-menu-2").removeClass("navigation-item-container-menu-active")
	...
	$(".pricing").hide()
	$(".pricing-1").show()
	$(".navigation-scnd-item-container-2-text").on("click", function () {
		$(".navigation-scnd-item-container-2-text").removeClass("active-value")
		$(this).addClass("active-value")
		$(".pricing").hide()
		$(".pricing-" + this.id).show()
	})
})
$(document).ready(function () {
	$(".honestGame").on("click", function () {
		$("#honestGameModal").fadeIn()
		$("#header-scnd-menu-1").hide()
		$(".navigation-item-container-menu-2").removeClass("navigation-item-container-menu-active")
		$("#header-scnd-menu-2").hide()
		$("#gamesRouter").removeClass("gamesRouter-active")
	...
	$("#honestModalClose").on("click", function () {
		$("#honestGameModal").fadeOut()
		$("#header-scnd-menu-1").hide()
		$(".navigation-item-container-menu-2").removeClass("navigation-item-container-menu-active")
		$("#header-scnd-menu-2").hide()
		$("#gamesRouter").removeClass("gamesRouter-active")
	...
	$("#honestGameModal").on("click", function (e) {
		$("#honestGameModal").fadeOut()
		$("#header-scnd-menu-1").hide()
		$(".navigation-item-container-menu-2").removeClass("navigation-item-container-menu-active")
		$("#header-scnd-menu-2").hide()
...
$(document).ready(function () {
	$(".dividend").on("click", function () {
		$("#dividendModal").fadeIn()
		$("#header-scnd-menu-1").hide()
		$(".navigation-item-container-menu-2").removeClass("navigation-item-container-menu-active")
		$("#header-scnd-menu-2").hide()
		$("#gamesRouter").removeClass("gamesRouter-active")
	...
	$("#dividendModalClose").on("click", function () {
		$("#dividendModal").fadeOut()
		$("#header-scnd-menu-1").hide()
		$(".navigation-item-container-menu-2").removeClass("navigation-item-container-menu-active")
		$("#header-scnd-menu-2").hide()
		$("#gamesRouter").removeClass("gamesRouter-active")
	...
	$("#dividendModal").on("click", function (e) {
		$("#dividendModal").fadeOut()
		$("#header-scnd-menu-1").hide()
		$(".navigation-item-container-menu-2").removeClass("navigation-item-container-menu-active")
		$("#header-scnd-menu-2").hide()
	...
	$(".game-activator").on("click", function () {
		$(".game-activator").removeClass("games-item-active")
		$(this).addClass("games-item-active")
		let text = $(this).text().trim()
		if (text.length > 8) {
			let result = text.slice(0, 8)
			$(".thisGame").text(result + '...')
		} else {
			$(".thisGame").text(text)
		}
		$(".game").hide()
		...
		if (screen.height<800) {
			$("#gameFrame").css("max-width","650px");
		} else if (screen.height<910) {
			$("#gameFrame").css("max-width","750px");
		} else {
			$("#gameFrame").css("max-width","1000px");
		}
		
		$(".autoPlayDice").prop("checked",false);
		$(".autoPlayNewDice").prop("checked",false);
		$(".autoPlayX50").prop("checked",false);
		
		if (this.id == 1 || this.id == 2 || this.id == 3 || this.id == 9) {
			$(".volumetoggler").show();
		} else {
			$(".volumetoggler").hide();
		}
		...
		if (this.id != 4) {
			document.getElementById('gameFrame').contentWindow.location.href="/NULL/";
		}
		/*
		console.log(this.id );
		if (this.id == 5 || this.id == 4 || this.id == 1 || this.id == 9) {
			$(".header-disnone-1").hide()
			$(".header-disnone-2").show()
		} else {
			$(".header-disnone-2").hide()
			$(".header-disnone-1").show()
			$(".header-games").show()
		}
		*/
	...
	var gameUrl = $("div[href^='"+hash+"'].game-activator a").attr('href');
	
	console.log("div[href^='"+hash+"'].game-activator");
	
	$("div[href^='"+hash+"'].game-activator").click();
	if (gameUrl !== undefined) {
		document.gameFrame.location.href=gameUrl;
	}

	$(".honestGame-inputs-flex-item-relative").slideUp()
	$("#honestGame-menutoggler").on("click", function () {
		$(".honestGame-inputs-flex-item-relative").stop()
		$(".honestGame-inputs-flex-item-relative").slideToggle()
		$("#header-scnd-menu-1").hide()
		$(".navigation-item-container-menu-2").removeClass("navigation-item-container-menu-active")
		$("#header-scnd-menu-2").hide()
		$("#gamesRouter").removeClass("gamesRouter-active")
	...
	$(".blur").on("click", function () {
		$("#faqModal .item-content").slideUp()
		$("#rulesModal .game-rule-content").slideUp()
		$(".honestGame-inputs-flex-item-relative").slideUp()
		$("#header-scnd-menu-1").hide()
		$(".navigation-item-container-menu-2").removeClass("navigation-item-container-menu-active")
		$("#header-scnd-menu-2").hide()
	...
	$("#faqModalClose").on("click", function () {
		$("#faqModal").fadeOut()
		$("#header-scnd-menu-1").hide()
		$(".navigation-item-container-menu-2").removeClass("navigation-item-container-menu-active")
		$("#header-scnd-menu-2").hide()
...
$(".hamburger-game5").removeClass("navigation-item-container-menu-active")
	...
	$("#rulesModalClose").on("click", function () {
		$("#rulesModal").fadeOut()
		$("#header-scnd-menu-1").hide()
$(".navigation-item-container-menu-2").removeClass("navigation-item-container-menu-active")
$("#header-scnd-menu-2").hide()
...
$(".get-trigger").on("click", function () {
	$("#getModal").fadeIn()
})
$("#getModalClose").on("click", function () {
	$("#getModal").fadeOut()
})
$("#getModal").on("click", function (e) {
	$("#getModal").fadeOut()
})
$(".modalget").click(function (e) {
	e.stopImmediatePropagation();
});


$(".take-trigger").on("click", function () {
	$("#takeModal").fadeIn()
})
$("#takeModalClose").on("click", function () {
	$("#takeModal").fadeOut()
})
$("#takeModal").on("click", function (e) {
	$("#takeModal").fadeOut()
})
$(".modaltake").click(function (e) {
	e.stopImmediatePropagation();
});



$(".volumetoggler").on("click", function () {
	$(".volumeImage").toggleClass("volume-active")
})

$(".langToggle").on("click", function () {
	$(".langmenu").toggleClass("lang-active")
})

$(".getDividends").on("click", function () {
	getDividents();
})

$(".getLEX").on("click", function () {
	getLEX();
})



$(".table-head-1 .table-head-item").on("click", function (e) {
	$(".table-head-1 .table-head-item").removeClass("active-table-head")
	$("."+e.target.id+"Stat").addClass("active-table-head")
	$(".table-players-1 .table-wrapper").hide()
	$(".table-players-1 .table-wrapper-" + e.target.id).show()
	//alert(e.target.id);
	
	statPage = e.target.id;
	
	//console.log("e.target.id="+statPage);
})

$(".table-head-2 .table-head-item").on("click", function (e) {
	$(".table-head-2 .table-head-item").removeClass("active-table-head")
	$(e.target).addClass("active-table-head")
	$(".table-players-2 .table-wrapper").hide()
	$(".table-players-2 .table-wrapper-" + e.target.id).show()
})
...
$(function () {
 ...
 var handle = $("#custom-handle3");
  ...
  $("#slider-range").slider({
    ...
    // }
      if (ui.values[0] == ui.values[1]) {
		...
		var multi = doMultiple(ui.values[1] - ui.values[0] - 1);
        $("#multiplier1").val(multi);
		multi = multi.slice(0, -1);
        $("#payout1").val(doPayout1(ui.values[1] - ui.values[0] - 1 ));
		...
		checkMaxBet("#bet-amount1", "#payout1", multi, $("#bet-amount1").val()*1e6);
      }
    },
  ...
  $("#bet-amount1").on('keyup', function () {
	...
	checkMaxBet("#bet-amount1", "#payout1", multi, current*1e6);
  });
/*
  $(".ch-coin").on('click', function () {
    var link = $(this).find('img').attr('src');
...
const spinner = $('.colored_circle-wrapper')
let transformation = 0
const audioX50 = $('#audiox50')[0];
const audioSpin = $('#audio1')[0];

let myBet = {
	player: null,	
	value: {2:0,3:0,5:0,50:0},
	coin: null
}
...
function startCounting() {
	//var timingBetweenRotating = 15534;
	//var countFromValue = Number(timingBetweenRotating/1000);
...
function starting() {
	$("#counterWrapper--text").text(translate['stop_placing_bets'])
	$(".currentText").toggle()
	toggling(true)
	setTimeout(() => {
		//let randElement = nums[Math.floor(Math.random() * (nums.length))];
		//console.log("randNumber=",randNumber);
		let randElement = nums[randNumber];
...
function toggling(boolean) {
	$("#rollx50").prop('disabled', boolean);
	$("#bet-amountx50").prop('disabled', boolean);
	$(".coin-stripe-x50 input").prop('disabled', boolean);
	$(".coin-stripe-x50 .ch-coin").css("pointer-events", boolean ? "none" : "auto")
	$("#x50Fields").css("opacity", boolean ? ".7" : "1").css("pointer-events", boolean ? "none" : "auto")
}
...
function rotating(randElement, transformation, currentRotate) {
	...
	if ($('.volume-active').attr('src')=="img/volume-on.svg" && x50page) {
		audioSpin.play();
	}
	setTimeout(() => {
...
function fixing(randElement, transformation) {
	...
	$("<style>#counterWrapper--text, #counter, #yourPayout { color: " + randElement.colorHex + " } .x50_circle__arrowSpin::after { border-color:"  + randElement.colorHex +   " transparent transparent; !important }</style>").appendTo("head")
	setTimeout(() => {
		$("#counterWrapper--text").text(translate['preparing_next_round'])
		let myBetsValue = myBet.value[2] +  myBet.value[3] +  myBet.value[5] +  myBet.value[50];
		let myWinValue = myBet.value[randElement.x] * (randElement.x+0);
		//console.log(myBetsValue,myWinValue,myBet.value[randElement.x], randElement.x);
		if( myWinValue > myBetsValue) {
				// alert("Вы поставили: " + myBet.value + " " + myBet.coin + " на " + myBet.color + "! Победил: " + randElement.color + " Поздравляем, вы выиграли!")
			if ($('.volume-active').attr('src')=="img/volume-on.svg") {
				audioX50.play()
			}
			$("#yourPayout").text("+" + (myWinValue-myBetsValue) + " " + myBet.coin)
			$("#yourPayout").show();				
		} else if (myBetsValue>0) {
			$("#yourPayout").text((myWinValue-myBetsValue) + " " + myBet.coin)
			$("#yourPayout").show();
		}
		myBet.value[2] = 0
		...
		setTimeout(() => {
			betsTableUpdating(true);
		}, 3000);
		
		betsHistoryUpdating();
		//betsHistoryMethod(randElement.color)
		//setTimeout(() => {
		//	startCounting()
		//}, 2000);
	}, 1000);
...
$(".rollx50").on("click", function () {
	let myBetVal = $("#bet-amountx50").val()
	let myBetColor = $("#x50Inputs").find("input:checked").val()
	let myBetCoin = $(".coin-stripe-x50").find("input:checked").val()
	//myBet.value = myBetVal
	//myBet.color = myBetColor
	//myBet.coin = myBetCoin
	var x;
	//toggling(true)
	//betsPushing(myBetColor)
	if (myBetColor=="blue") {
		x=2;
	}
	if (myBetColor=="red") {
	...
	x50Bets(x, myBetVal,x50betID);
})

/*
function betsPushing(myBetColor) {
	for (let i in bets) {
		i === myBetColor ? bets[i].push(myBet) : false
	}
	betsTableUpdating(false) 
}
*/

function betsTableUpdating(deleting) {
	if(!deleting) {
		let blueValue = 0
		let redValue = 0
		let greenValue = 0
		let goldValue = 0
		for (let i = 0; i < bets.blue.length; i++) {
			$("#betsTable-blue").append(
				`<tr class="body_2 col-lg-3">
						<td class= "c-1" >`+ bets.blue[i].player +`<span class="gap">` + bets.blue[i].value + " " + bets.blue[i].coin + `</span></td>
				</tr >');`)
			$("#tablePeople-blue").text(Number($("#tablePeople-blue").text())+1);
			$("#tableValue-blue").text(Number($("#tableValue-blue").text())+parseInt(bets.blue[i].value));
			//blueValue += parseInt(bets.blue[i].value)
		}
		for (let i = 0; i < bets.red.length; i++) {
			$("#betsTable-red").append(
				`<tr class="body_2 col-lg-3">
						<td class= "c-2" >`+ bets.red[i].player +`<span class="gap">` + bets.red[i].value + " " + bets.red[i].coin + `</span></td>
				</tr >');`)
			$("#tablePeople-red").text(Number($("#tablePeople-red").text())+1);
			$("#tableValue-red").text(Number($("#tableValue-red").text())+parseInt(bets.red[i].value));
			//redValue += parseInt(bets.red[i].value)
		}
		for (let i = 0; i < bets.green.length; i++) {
			$("#betsTable-green").append(
				`<tr class="body_2 col-lg-3">
						<td class= "c-3" >`+ bets.green[i].player +`<span class="gap">` + bets.green[i].value + " " + bets.green[i].coin + `</span></td>
				</tr >');`)
			$("#tablePeople-green").text(Number($("#tablePeople-green").text())+1);
			$("#tableValue-green").text(Number($("#tableValue-green").text())+parseInt(bets.green[i].value));
			//greenValue += parseInt(bets.green[i].value)
		}
		for (let i = 0; i < bets.gold.length; i++) {
			$("#betsTable-gold").append(
				`<tr class="body_2 col-lg-3">
						<td class= "c-4" >`+ bets.gold[i].player +`<span class="gap">` + bets.gold[i].value + " " + bets.gold[i].coin + `</span></td>
				</tr >');`)
			$("#tablePeople-gold").text(Number($("#tablePeople-gold").text())+1);
			$("#tableValue-gold").text(Number($("#tableValue-gold").text())+parseInt(bets.gold[i].value));
			//goldValue += parseInt(bets.gold[i].value)
		}
		//$("#tableValue-blue").text(blueValue)
		//$("#tableValue-red").text(redValue)
		//$("#tableValue-green").text(greenValue)
		//$("#tableValue-gold").text(goldValue)
	} else if (deleting) {
		$("#betsTable-red").empty()
		$("#betsTable-blue").empty()
		$("#betsTable-green").empty()
		$("#betsTable-gold").empty()
		bets.blue = []
		bets.red = []
		bets.green = []
		bets.gold = []
		$("#tableValue-blue").text("0")
		$("#tableValue-red").text("0")
		$("#tableValue-green").text("0")
		$("#tableValue-gold").text("0")
		$("#tablePeople-blue").text("0")
		$("#tablePeople-red").text("0")
		$("#tablePeople-green").text("0")
		$("#tablePeople-gold").text("0")
	}
}

/*
function betsHistoryMethod (color) {
	if(betsHistory.length <= 20) {
		betsHistory.push(color)
	} else {
		betsHistory.splice(0, 1)
		betsHistory.push(color)
	}
	betsHistoryUpdating()
}
...
function betsHistoryUpdating() {
	$(".x50_circle__last_colors").empty()
	for (let i = 0; i < betsHistory.length; i++) {
		$(".x50_circle__last_colors").append(
			`<div class="x50_circle__last_colors__item x50_circle__last_colors__item-` + nums[betsHistory[i]].color + `"></div>`)
	}
}
...
function rewriting() {
	setTimeout(() => {
		let myBetVal = $("#bet-amountx50").val()
		let myBetColor = $("#x50Inputs").find("input:checked").val()
		let myBetCoef = myBetColor === "blue" ? 2 : myBetColor === "red" ? 3 : myBetColor === "green" ? 5 : myBetColor === "gold" ? 50 : false
		$("#x50Payout input").val(myBetVal * myBetCoef)
		//myBet.payout = myBetVal * myBetCoef
	}, 10);
}



$("#x50Fields *").on("input propertychange", function () {
	rewriting()
})
