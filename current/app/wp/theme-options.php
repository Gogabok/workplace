...
function theme_options_do_page() {
	...
	<div class="wrap">
        ...
        <tr valign="top"><th scope="row"><?php _e( 'Email', 'sampletheme' ); ?></th>
				...
				<tr valign="top"><th scope="row"><?php _e( 'Курс доллара', 'sampletheme' ); ?></th>
					<td>
						<input id="sample_theme_options[kurs]" class="regular-text" type="text" name="sample_theme_options[kurs]" value="<?php esc_attr_e( $options['kurs'] ); ?>" />
					</td>
				</tr>

				<tr valign="top"><th scope="row"><?php _e( 'Instagram', 'sampletheme' ); ?></th>
					<td>
						<input id="sample_theme_options[telega]" class="regular-text" type="text" name="sample_theme_options[telega]" value="<?php esc_attr_e( $options['telega'] ); ?>" />
					</td>
				</tr>
