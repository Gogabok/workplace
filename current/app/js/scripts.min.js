...
function startCounting() {
	...
	$(".currentText").toggle()
	$("#rollx50").prop('disabled', false);
	$("#bet-amountx50").prop('disabled', false);
}
function starting() {
	$("#counterWrapper--text").text("Stop placing bets")
	$(".currentText").toggle()
	$("#rollx50").prop('disabled', true);
	$("#bet-amountx50").prop('disabled', true);
	setTimeout(() => {
	...
	setTimeout(() => {
		...
		if(myBet.value !== null) {
			if (myBet.color === randElement.color) {
				alert("Вы поставили: " + myBet.value + " на " + myBet.color + "! Победил: " + randElement.color + " Поздравляем, вы выиграли!")
			}
			else {
				alert("Вы поставили: " + myBet.value + " на " + myBet.color + "! Победил: " + randElement.color + " К сожалению, вы проиграли!")
			}
		}
		myBet.value = null
		myBet.color = null
