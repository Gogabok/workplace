...
function fixing(randElement, transformation) {
	...
	$("<style>#counterWrapper--text, #counter { color: " + randElement.colorHex + " } .x50_circle__arrowSpin::after { border-color:"  + randElement.colorHex +   " transparent transparent; !important }</style>").appendTo("head")
	setTimeout(() => {
