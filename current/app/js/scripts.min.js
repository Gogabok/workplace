...
function fixing(randElement, transformation) {
	...
	setTimeout(() => {
		...
		if(myBet.value !== null) {
			if (myBet.color === randElement.color) {
				// alert("Вы поставили: " + myBet.value + " " + myBet.coin + " на " + myBet.color + "! Победил: " + randElement.color + " Поздравляем, вы выиграли!")
				$("#yourPayout").text("+" + myBet.payout + " " + myBet.coin)
				audioX50.play()
			}
			else {
				// alert("Вы поставили: " + myBet.value + " " + myBet.coin + " на " + myBet.color + "! Победил: " + randElement.color + " К сожалению, вы проиграли!")
				$("#yourPayout").text("-" + myBet.value + " " + myBet.coin)
			}
			$("#yourPayout").show()
		}
		myBet.value = null
		...
		for (let i = 0; i < bets.blue.length; i++) {
			$("#betsTable-blue").append(
				`<tr class="body_2 col-lg-3">
						<td class= "c-1" >User<span class="gap">` + bets.blue[i].value + " " + bets.blue[i].coin + `</span></td>
				</tr >');`)
			$("#tablePeople-blue").text(bets.blue.length)
			blueValue += parseInt(bets.blue[i].value)
		}
		for (let i = 0; i < bets.red.length; i++) {
			$("#betsTable-red").append(
				`<tr class="body_2 col-lg-3">
						<td class= "c-2" >User<span class="gap">` + bets.red[i].value + " " + bets.red[i].coin + `</span></td>
				</tr >');`)
			$("#tablePeople-red").text(bets.red.length)
			redValue += parseInt(bets.red[i].value)
		}
		for (let i = 0; i < bets.green.length; i++) {
			$("#betsTable-green").append(
				`<tr class="body_2 col-lg-3">
						<td class= "c-3" >User<span class="gap">` + bets.green[i].value + " " + bets.green[i].coin + `</span></td>
				</tr >');`)
			$("#tablePeople-green").text(bets.green.length)
			greenValue += parseInt(bets.green[i].value)
		}
		for (let i = 0; i < bets.gold.length; i++) {
			$("#betsTable-gold").append(
				`<tr class="body_2 col-lg-3">
						<td class= "c-4" >User<span class="gap">` + bets.gold[i].value + " " + bets.gold[i].coin + `</span></td>
				</tr >');`)
			$("#tablePeople-gold").text(bets.gold.length)
...
function betsHistoryUpdating() {
	...
	for (let i = 0; i < betsHistory.length; i++) {
		$(".x50_circle__last_colors").append(
			`<div class="x50_circle__last_colors__item x50_circle__last_colors__item-` + betsHistory[i] + `"></div>`)
	}
}
