            ...
            <div class="col-sm-9">
              <div class="inner__top">
                ...
                <ul class="breadcrumbs">
                  ...
                  <li><nuxt-link :to="`/catalog/${$route.params.modification}/section/${$route.params.id}`">{{currentSection && currentSection.description}}</nuxt-link></li>
                </ul>
              </div>
            </div>
          </div>
      ...
      if(!this.$route.query.page) {
        api.getChildSection(this.$route.params.modification, this.$route.params.id)
          ...
          .then(response => {
            ...
            return api.getCarInfoByModificationId(this.$route.params.modification)
          })
          .then(response => {
